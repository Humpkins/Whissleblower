...
class LOGGER {
    public:
        ...
        char constPath[36];
        File logFile;
        char stateFile[18] = "/wasRecording.txt";
        ...
        int autoStartLog(){
            ...
            Serial.print("Check if it was Recording data on the last runtime");
        ...
        int startLog(){
            ...
            if ( !this->recording ) {
                ...
                // 34 fields
                if ( !this->logFile.print(fileHeader) ){
        ...
        void updateFile(){
            ...
            //  Check if SD is mounted
            if ( !sd_card.mountSD() ) {
                Serial.println("[FAIL]      Error SD mounting. Stop logging service");
                this->stopLog();
            }

            if ( !this->logFile ) {
                this->logFile = SD.open(this->constPath, FILE_APPEND);
            }


            char dataToBeSaved[470  ];
            sprintf(
                dataToBeSaved,
            ...
            if ( !this->logFile.print( dataToBeSaved ) ) {
